    ...
    info = @Info(
        ...
        description = """
            ...
            **Authorize** and paste the token. Access tokens expire after 15 minutes.
            ...
            Carts are anonymous and identified by their UUID. Managing products and listing users requires the \
            `ADMIN` role. Checkout needs `STRIPE_SECRET_KEY`; without it `POST /checkout` returns a 500.
            """
    ),
