...
public class SwaggerSecurityRules implements SecurityRules {
    ...
    public void configure(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry registry) {
        registry
            ...
            // Fix beyond the course: the health check (railway.json) is public, GET and HEAD (uptime monitors often probe with HEAD); /actuator itself and every other actuator path stay behind authentication (401).
